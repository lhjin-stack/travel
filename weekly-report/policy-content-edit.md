...
> **[NEW 3/20] NSA → POL Ship-back 관련 안내**
> 1. 기본규정
>    - Ship-back은 NSA도착 했던 선박으로만 가능 (ROB ship-back만 가능)
>    - 다른선박으로 선적되는 경우 Re-export처리됨
>    - Re-export의 경우 약 3~4개월 정도 시간 소요 및 세관 요구서류 많음
>    - 관련 비용 선사 책임 + 세관 페널티 부과 가능
> 2. 인도 선사협의회 (CSLA)를 통한 세관 협의 진행
>    - CSLA 웹 미팅 결과, 타 선사들 역시 동일한 문제 겪고 있음
>    - CSLA에서는 POL ship-back대상 건에 대한 리스트 취합 후 세관측에 협조 요청 예정
>    - 빠르면 3/23(월) 또는 3/24(화) 세관과 협의 결과 확인 가능할 것으로 예상
